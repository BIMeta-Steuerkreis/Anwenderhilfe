...
## Properties - Merkmale
In BIMeta werden in der Merkmalstabelle nicht die Daten, sondern die Metadaten ([Unterschied zwischen Daten und Metadaten](3.3_weitereErlauterungen.md#unterschied-von-daten-und-metadaten) verwaltet. Diese Tabelle ist nach der DIN EN ISO 23386 strukturiert und ermöglicht dadurch den Austausch und die Kommunikation mit anderen Systemen.
...
Merkmale werden versioniert. Die Versionen der Merkmale werden nach dem Prinzip der [Semantischen Versionierung](3.3_weitereErlauterungen.md#semantische-versionierung) nummeriert.
